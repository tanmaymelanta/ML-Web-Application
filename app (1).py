...
def main():
    ...
    @st.cache_resource
    def load_data():
        data = pd.read_csv("C:/Users/melantata/Downloads/mushrooms.csv")
        label = LabelEncoder()
    ...
    if classifier == "Random Forest":
        st.sidebar.subheader("Model Hyperparameters")
        n_estimators = st.sidebar.number_input("Number of Trees in a forest", 100, 5000, step=10, key='n_estimators')
